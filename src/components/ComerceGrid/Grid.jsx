    ...
    return <div className="grid">
        <div className="filters">
            ...
            <form className='form' onSubmit={productsByName}>
                ...
                <br></br>
                <input type="submit" value="Search" className='user-button' />
            </form>
            <br></br>
            <div className='form'>
                <span>Order by</span>
                <ul className="filter-list">
                    ...
                    <li>
                        <button className='grid-button' onClick={orderMinorToMaxThc}>
                            {azOrZaTHC === 'az'
                    ...
                    <li>
                        <button className='grid-button-price' onClick={orderByPrice}>
                            {azOrZaPrice === 'az'
